    ...
    <div class=\"card-body\">
        ...
        echo "\" class=\"btn btn-sm btn-outline-secondary\">Edit</a>
            ...
            <small class=\"text-muted\">
                ";
        // line 19
        echo twig_escape_filter($this->env, (twig_round((((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 19, $this->source); })()), "text", [], "any", false, false, false, 19)) > 3)) ? ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 19, $this->source); })()), "text", [], "any", false, false, false, 19)) / 200)) : (""))) . " minutes"), "html", null, true);
        echo "
            </small>
        </div>
    </div>
...
<div class=\"card shadow-sm\">
    ...
    <div class=\"card-body\">
        ...
        <div class=\"d-flex justify-content-between align-items-center\">
            ...
            <small class=\"text-muted\">
                {{(article.text|length > 3 ? article.text|length/200)|round ~ ' minutes'}}
            </small>
        </div>
    </div>
</div>", "_partials/article-card.html.twig", "/code/templates/_partials/article-card.html.twig");
    }
}
